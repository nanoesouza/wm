...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" },            "w",     function () awful.util.spawn("wifimenu") end,
              {description = "wifi menu", group = "rofi"}),
    awful.key({ modkey },            "y",     function () awful.util.spawn("meu-amor") end,
              {description = "dia dos namorados", group = "rofi"}),
